...
/** Callback method which is called during device registration in order to give equipments an opportunity to perform additional initialisation if required. Override this method to provide custom initialization. You *MUST* call completion block in the of your
